...
There are many natural choices for the case-style of a heading. With the Jupyter Book project, we've settled on [sentence case](wiki:Letter_case#Stylistic_or_specialised_usage).
